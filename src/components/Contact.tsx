                        ...
                        <div className='my-4 flex flex-col gap-4'>
                            <div className="flex gap-3 items-center">
                                ...
                                <div>
                                    ...
                                    <span className='text-sm font-regular'>Haider Ali Amjad </span>
                                </div>
                            </div>
                            <div className="flex gap-3 items-center">
                                ...
                                <div>
                                    ...
                                    <span className='text-sm font-regular'>Lahore,Pakistan </span>
                                </div>
                            </div>
                            <div className="flex gap-3 items-center">
                                ...
                                <div>
                                    ...
                                    <span className='text-sm font-regular'>haiderali226433@gmail.com</span>
                                </div>
                            </div>
                        </div>
                    </div>
